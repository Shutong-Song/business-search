...
def create_search_textbox():
    return dbc.InputGroup([
                    ...
                    dbc.Button(id = "speech", 
                                   style = {"width": "30px", "height":"30px", "background-image": 'image_url(/assets/speech.png)', 
...
def create_search_button():
    return dbc.Button(id='search_button', 
                      style = {"width": "50px", "height":"50px", "background-image": 'image_url(/assets/search_button_logo.png)', 
                                "background-size": "cover",
